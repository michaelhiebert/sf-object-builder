...
export default class Alert extends React.Component {
  render() {
    const typeToClassName = {
        ...
        warning: "slds-notify slds-notify_alert slds-theme_alert-texture slds-theme_warning",
        error: "slds-notify slds-notify_alert slds-theme_alert-texture slds-theme_error",
    };

    const typeToIcon = {
        info: "/assets/icons/utility-sprite/svg/symbols.svg#user",
    ...
    return (
      <div
        className={typeToClassName[this.props.alert.type]}
        role="alert"
      >
        <span class="slds-assistive-text">{this.props.alert.type}</span>
        <span
