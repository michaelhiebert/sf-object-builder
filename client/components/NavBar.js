          ...
          <div className="slds-col slds-has-flexi-truncate">
            <div className="slds-media slds-media--center slds-no-space slds-grow">
              ...
              <div className="slds-media__body">
                <p className="slds-page-header__title slds-truncate slds-align-middle" title="Salesforce Object Builder">
                  Salesforce Object Builder
                </p>
                <p className="slds-text-body--small page-header__info">Convert your CSVs into Salesforce Objects</p>
              </div>
            </div>
          </div>
